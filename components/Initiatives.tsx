      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {initiativeData.map((project) => (
            <div
              key={project.id}
              className="bg-muted rounded-xl shadow-sm overflow-hidden flex flex-col items-center p-6 text-center transition-shadow duration-300 hover:shadow-xl"
            >
              ...
              <h3 className={`text-xl font-bold ${TEXT_COLOR} mb-2`}>
                {project.title}
              </h3>
        ...
        <div className="text-center mt-16">
          <Link href="/donate">
            <Button variant="secondary" className="inline-block py-3 px-8 rounded-full font-bold transition duration-300 shadow-md text-lg">
